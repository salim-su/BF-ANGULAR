...
export class AuthDictEditItemComponent implements OnInit {
  ...
  constructor(
    ...
    this.form = new FormGroup({
      ...
      dictValue: new FormControl({ value: null}, Validators.required),
      code: new FormControl({ value: null}, Validators.required),
      sort: new FormControl({ value: null}, Validators.required),
      dictKey: new FormControl({ value: null}, Validators.required),
